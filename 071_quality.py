        ...
        if os.path.isdir(full_path) and 'difficulty' in name and 'gap' in name:
            try:
                ...
                with open(os.path.join(full_path, "quality_report.json"), "r") as f:
                    ...
                    if budget in [0.0,50.0,100.0,150.0,180.0,200.0,264.0,300.0,350.0,400.0,450.0,480.0,529.0,793.0,1058.0,1322.0,1586.0,1851.0,2115.0,2380.0,2644.0]:
                        data = json.load(f)
                        print(theta)
                        print(budget)
                        row = [
                            ...
                            (f1_gnn_1.get(theta)[0]*f1_gnn_1.get(theta)[1] + data.get("1_avg_f1")*data.get("1_num_repairs"))/(f1_gnn_1.get(theta)[1]+data.get("1_num_repairs")),                                   
                            (f1_gnn_2.get(theta)[0]*f1_gnn_2.get(theta)[1] + data.get("2_avg_f1")*data.get("2_num_repairs"))/(f1_gnn_2.get(theta)[1]+data.get("2_num_repairs")),
                            (f1_gnn_3.get(theta)[0]*f1_gnn_3.get(theta)[1] + data.get("3_avg_f1")*data.get("3_num_repairs"))/(f1_gnn_3.get(theta)[1]+data.get("3_num_repairs"))
                        ]
