...
#             for budget in 2403; do
#                 echo "Running precheck with dataset: $dataset, theta: $theta, metric: difficulty budget: $budget"
#                 python3 04_compute_llm_quality.py --dataset "$dataset" --theta "$theta" --metric "$metric" --budget "$budget"
#                 done
#             done 
#         done
#     done
