...
budget_values = [100.0, 264.0, 2644.0]
#budget_values = [264.0, 2644.0]
...
fig.suptitle(
    "FAERS F1 Score and Average Cost per Repair by Theta and Budget",
    fontsize=16,
    y=1.02
)
...
plt.savefig(
    "faers_quality_summary_grid.png",
    dpi=600,
    bbox_inches="tight"
)
