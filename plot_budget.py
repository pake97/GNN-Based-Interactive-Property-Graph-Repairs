...
x = [0.0,50.0,100.0,150.0,180.0,200.0,264.0,300.0,350.0,400.0,450.0,480.0,529.0,793.0,1058.0,1322.0,1586.0,1851.0,2115.0,2380.0,2644.0]
# for i in range(11):
#     theta = i / 10
...
for i in range(11):
    ...
    y = [0.8691399662731872]*len(x) if i < 5 else subset['combined_f1']
    xvals = x if i < 6 else subset['budget']
    plt.plot(
        xvals, y,
...
for i in range(11):
    ...
    # draw the curve (no markers)
    y = [0.8691399662731872]*len(x) if i < 2 else subset['combined_f1_1']
...
for i in range(11):
    ...
    # draw the curve (no markers)
    y = [0.8691399662731872]*len(x) if i < 2 else subset['combined_f1_2']
    xvals = x if i < 2 else subset['budget']
    plt.plot(
        xvals, y,
        linestyle='--' if i < 2 else '-',
...
for i in range(11):
    ...
    subset = subset[subset['budget'].isin(x)]
    # draw the curve (no markers)
    y = [0.8691399662731872]*len(x) if i < 2 else subset['combined_f1_3']
    xvals = x if i < 2 else subset['budget']
    plt.plot(
        xvals, y,
        linestyle='--' if i < 2 else '-',
...
# x = df['budget'].astype(float).unique().tolist()
# print(x)
# x.append(0)
# x.sort()
# print(x)
