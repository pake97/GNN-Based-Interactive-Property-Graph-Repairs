...
<<<<<<< HEAD
#config.DATABASE_URL = "bolt://neo4j:porcodio@localhost:7687/neo4j"
...
>>>>>>> f6b8c9efecb11ba957b6375f10b93ff9ab343941
...
<<<<<<< HEAD
        if(dataset=='synthea'):
            try:
                injest('/Users/amedeo/Desktop/CGR_Experiments/ENV/config/synthea.yml')
            except Exception as e:
                print(e)
        elif(dataset=='synthea25'):
            try:
                injest('/Users/amedeo/Desktop/CGR_Experiments/ENV/config/synthea25.yml')
            except Exception as e:
                print(e)
                
        elif(dataset=='synthea50'):
            try:
                injest('/Users/amedeo/Desktop/CGR_Experiments/ENV/config/synthea50.yml')
            except Exception as e:
                print(e)
        elif(dataset=='synthea75'):
            try:
                injest('/Users/amedeo/Desktop/CGR_Experiments/ENV/config/synthea75.yml')
            except Exception as e:
                print(e)
        elif(dataset=='synthea100'):
            try:
                injest('/Users/amedeo/Desktop/CGR_Experiments/ENV/config/synthea100.yml')
            except Exception as e:
                print(e)
        elif(dataset=='synthea125'):
            try:
                injest('/Users/amedeo/Desktop/CGR_Experiments/ENV/config/synthea125.yml')
            except Exception as e:
                print(e)
        elif(dataset=='synthea150'):
            try:
                injest('/Users/amedeo/Desktop/CGR_Experiments/ENV/config/synthea150.yml')
            except Exception as e:
                print(e)
        elif(dataset=='synthea200'):
            try:
                injest('/Users/amedeo/Desktop/CGR_Experiments/ENV/config/synthea200.yml')
            except Exception as e:
                print(e)
        elif(dataset=='synthea500'):
            try:
                injest('/Users/amedeo/Desktop/CGR_Experiments/ENV/config/synthea500.yml')
            except Exception as e:
                print(e)
        elif(dataset=='synthea1000'):
            try:
                injest('/Users/amedeo/Desktop/CGR_Experiments/ENV/config/synthea1000.yml')
            except Exception as e:
                print(e)
        else:
            try:
                os.system('/Users/amedeo/Downloads/neo4j-community-5.12.0/bin/cypher-shell -u neo4j -p AmePake97 -f ./data/'+dataset+'.cypher')
            except Exception as e:
                print(e)
=======
        ...
        try:
            os.system('<PATH_TO_NEO$J>/bin/cypher-shell -u neo4j -p <PASSWORD> -f ./data/'+dataset+'.cypher')            
        except Exception as e:
            print(e)
>>>>>>> f6b8c9efecb11ba957b6375f10b93ff9ab343941
